...
public:
  ...
  DielectricBSDF(const BRDF *reflective, const BTDF *refractive,
                 float _Fresnel_R0)
      : BSDF(_Fresnel_R0), reflective_material(reflective),
        transmissive_material(refractive) {}
...
public:
  ...
  GlassBTDF(float _ior, bool _entering = true) : ior(_ior), entering(_entering) {}
